<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="AddStudyInfo.aspx.cs"  EnableEventValidation="false" ValidateRequest="false" Inherits="Admin_AddStudyInfo" Title="Untitled Page" %>
    ...
    <table align="center" border="0" cellpadding="3" cellspacing="1" class="" style="width: 100%">
        <tr>
            <td class="left_title_1" height="30" style="width: 88px">
                标题：</td>
            <td align="left" height="30" style="width: 737px">
        ...
        <tr>
            <td class="left_title_1" height="30" style="width: 88px">
                所属课程：</td>
            <td height="30" style="width: 737px" align="left">
        ...
        <tr>
            <td class="left_title_1" style="width: 88px; height: 119px">
                内容：</td>
            <td style="width: 737px; height: 119px">
