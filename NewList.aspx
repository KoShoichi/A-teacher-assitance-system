<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="NewList.aspx.cs" Inherits="NewList" Title="Untitled Page" %>
    ...
    <asp:GridView ID="dlinfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="查看">
                <ItemTemplate>
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "ShowNewInfo.aspx?id="+Eval("id") %>'
