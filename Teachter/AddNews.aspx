<%@ Page Language="C#" MasterPageFile="~/Teachter/MasterPage.master" AutoEventWireup="true" CodeFile="AddNews.aspx.cs"   EnableEventValidation="false" ValidateRequest="false" Inherits="Admin_AddNews" Title="Untitled Page" %>
    ...
    <table align="center" border="0" cellpadding="3" cellspacing="1" class="" style="width: 100%">
        ...
        <tr>
            ...
            <td style="width: 621px; height: 119px">
                <FCKeditorV2:FCKeditor ID="txtcontents" runat="server" Height="300px">
