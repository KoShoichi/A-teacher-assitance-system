<%@ Page Language="C#" MasterPageFile="~/Teachter/MasterPage.master" AutoEventWireup="true" CodeFile="Modify_ZuoYe.aspx.cs" Inherits="Admin_Modify_ZuoYe" Title="Untitled Page" %>
    ...
    <table align="center" bgcolor="#d5d4d4" border="0" cellpadding="0" cellspacing="1"
        ...
        <tr>
            <td background="images/bg.gif" bgcolor="#ffffff" class="STYLE3" colspan="4" height="22">
                <div align="center">
                    修改作业<asp:Label ID="Label2" runat="server" ForeColor="Red"></asp:Label></div>
            </td>
        </tr>
