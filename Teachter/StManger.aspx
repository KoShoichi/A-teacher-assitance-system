<%@ Page Language="C#" MasterPageFile="~/Teachter/MasterPage.master" AutoEventWireup="true" CodeFile="StManger.aspx.cs" Inherits="Admin_StManger" Title="Untitled Page" %>
    ...
    <asp:GridView ID="gvFilms" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="班级">
                <ItemTemplate>
                    <asp:Label ID="BanJi" runat="server" Text='<%# Bind("BanJi") %>'></asp:Label>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Left" Width="80px" />
            </asp:TemplateField>
